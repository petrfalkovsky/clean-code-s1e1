...
var editTask = function(){
  ...
  var editInput = listItem.querySelector('.task-text__input');
  var label = listItem.querySelector('.task__label');
  var editBtn = listItem.querySelector('.button-edit');
  var containsClass = listItem.classList.contains('edit-mode__item');
  ...
  listItem.classList.toggle('edit-mode__item');
};
